...
SuccessModule = __decorate([
    (0, common_1.Module)({
        providers: [success_service_1.SuccessService],
        controllers: [success_controller_1.SuccessController]
    })
], SuccessModule);
exports.SuccessModule = SuccessModule;
